...
local Window = OrionLib:MakeWindow({Name = "QFB|Blox Fruit", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Sla Hub"})
    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                ...
                OrionLib:MakeNotification({
                    Name = "QFB",
                    Content = "Desligue Hop moon finder",
                    Image = "",
                    Time = 5
                })
...
OrionLib:MakeNotification({
        Name = "QFB",
        Content = "Carregando script, Agora você pode ativar as funçoes",
        Image = "",
        Time = 5
    })
...
OrionLib:MakeNotification({
    Name = "QFB Hub",
    Content = "Configuração sendo carregada!",
    Image = "",
    Time = 5
})
